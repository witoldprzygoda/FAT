...
void pepem_costheta() {
    ...
    // cos(theta_CMS) of pe+e- (OA > 9, M_ee > 0.14, MM proton window)
    TH1D *all1, *cb1, *sig1;
    std::tie(all1, cb1, sig1) = pu.drawSignal("pepem_nt", "pepem_costheta_cms",
                                                25, -1.0, 1.0,
    ...
    std::cout << "\n=== cos(theta_CMS) pe+e- (OA>9, M_ee>0.14, MM proton) ===\n";
