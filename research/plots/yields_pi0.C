...
void yields_pi0(const char* flavour = "rec") {
    ...
    const std::string fpath = "fit_results_" + fl + ".root";
    ...
    c1->Update();
    const std::string out1 = "plots/output/yield_pi0_" + fl + "_vs_oa";
    ...
    c2->Update();
    const std::string out2 = "plots/output/mu_pi0_" + fl + "_vs_oa";
